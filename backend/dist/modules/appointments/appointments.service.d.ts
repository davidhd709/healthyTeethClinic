...
export declare class AppointmentsService {
    ...
    constructor(appointmentModel: Model<AppointmentDocument>, emailService: EmailService, calendarService: GoogleCalendarService, sheetsService: GoogleSheetsService, patientsService: PatientsService);
    findByPatient(patientId: string): Promise<(import("mongoose").Document<unknown, {}, import("mongoose").Document<unknown, {}, Appointment, {}, import("mongoose").DefaultSchemaOptions> & Appointment & {
        _id: Types.ObjectId;
    } & {
        __v: number;
    } & {
